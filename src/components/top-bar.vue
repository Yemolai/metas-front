      ...
      b-collapse(is-nav)#nav_collapse
        ...
        b-navbar-nav
          b-nav-item(href="#" @click="go('Home')")
            span I
            small NÍCIO
          b-nav-item(href="#" @click="go('Painel')")
            span P
            small AINÉIS
          b-nav-item(href="#" @click="go('Setor')")
            span D
            small IRETORIA
          b-nav-item(href="#" @click="go('Coordenadoria')")
            span C
            small OORDENADORIA
        //- Aqui começa a parte à direita da barra
        b-navbar-nav.ml-auto
          b-nav-item(href="#" @click="go('AddMeta')").mx-2
